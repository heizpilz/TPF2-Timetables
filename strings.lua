function data()
    ...
    return {
        en = {
            ...
            ["to_i18n"] = "Until: ",
            ["last_dep_i18n"] = "Departure until",
            ["from_i18n"] = "After: ",
            ["first_dep_i18n"] = "Not before",
...
keep the constraints. The following constraints are available:
  ...
  - Unbunch: Set a time and vehicles will only depart the station in the given interval
        ...
        de = {
            ...
            ["to_i18n"] = "Bis: ",
            ["last_dep_i18n"] = "Abfahrt bis",
            ["from_i18n"] = "Nach: ",
            ["first_dep_i18n"] = "Nicht Vor",
